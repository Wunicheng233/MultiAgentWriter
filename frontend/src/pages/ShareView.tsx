    ...
    >
      ...
      <header className="border-b border-[var(--reader-border)] py-6 px-4 bg-white/60 backdrop-blur sticky top-0 z-10">
        <div className="max-w-5xl mx-auto">
          ...
          {/* 上一章/下一章导航 */}
          {project.chapters && project.chapters.length > 1 && currentChapterIndex !== null && (
            <div className="flex justify-center gap-4 mt-4 pt-4 border-t border-[var(--reader-border)]/30">
              <Button
                variant="secondary"
                size="sm"
